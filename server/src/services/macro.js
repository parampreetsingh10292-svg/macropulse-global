...
const NOWCAST = {
  ...
  india:   { gdp:6.8, inflation:4.1, bonds:6.72, unemployment:7.9, fiscalDeficit:4.9,  debtToGdp:83,  src:"MoSPI/RBI/CMIE/IMF Apr'26" },
  ...
  brazil:  { gdp:2.2, inflation:5.1, bonds:13.25,unemployment:7.8, fiscalDeficit:7.1,  debtToGdp:91,  src:"IBGE/BCB/IMF Apr'26" },
